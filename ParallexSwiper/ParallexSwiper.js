...
import { StyleSheet, Text, View, FlatList, Dimensions, Animated, Image, TouchableOpacity } from 'react-native'
...
export class ParallexSwiper extends Component {
  constructor(props) {
    super(props)
    this.state = {
      currentPage: 0,
